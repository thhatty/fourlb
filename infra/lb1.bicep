...
var lbPublicIpAddressName = '${environmentName}-lbPublicIP'
...
var natGatewayName = '${environmentName}-natgateway'
var natGatewayPublicIPAddressName = '${environmentName}-natPublicIP'
